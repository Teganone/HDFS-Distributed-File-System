 ...
 implements api.DataNodeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getUsedBlockNum", new java.lang.Integer (3));
    _methods.put ("getBlocksCapacity", new java.lang.Integer (4));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // api/DataNode/getUsedBlockNum
       {
         int $result = (int)0;
         $result = this.getUsedBlockNum ();
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 4:  // api/DataNode/getBlocksCapacity
       {
         int $result = (int)0;
         $result = this.getBlocksCapacity ();
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }
