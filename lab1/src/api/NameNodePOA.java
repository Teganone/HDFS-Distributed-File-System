 ...
 implements api.NameNodeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getRegisteredDataNodes", new java.lang.Integer (3));
  }
  ...
  //TODO: complete the interface design
       ...
       {
         int id = in.read_long ();
         this.registerDataNode (id);
         out = $rh.createReply();
         break;
       }

       case 3:  // api/NameNode/getRegisteredDataNodes
       {
         boolean $result[] = null;
         $result = this.getRegisteredDataNodes ();
         out = $rh.createReply();
         api.NameNodePackage.BooleanSequenceHelper.write (out, $result);
         break;
       }
